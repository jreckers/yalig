...
function restoreOptions() {
	...
	document.getElementById("timeFormat").value = chrome.extension.getBackgroundPage().settings.getTimeFormat();
 }
...
document.addEventListener('DOMContentLoaded', function () {
	...
	document.querySelector("#timeFormat").addEventListener("click", function() { setTimeFormat('HH.MM'); return false; });
