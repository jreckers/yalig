...
function createContextMenu() {
  ...
  chrome.contextMenus.create({
    ...
    contexts: ["editable"],
    onclick: function (info, tab) {
      insertText(createYesterdayString());
    },
  });
  chrome.contextMenus.create({
  ...
  chrome.contextMenus.create({
    ...
    contexts: ["editable"],
    onclick: function (info, tab) {
      insertText(createTomorrowString());
    },
  });
  chrome.contextMenus.create({
    ...
    contexts: ["editable"],
    onclick: function (info, tab) {
      insertText(createRandomDateString());
    },
  });
  chrome.contextMenus.create({
    type: "separator",
